...
namespace OnePieceTcg.Engine.Puzzles
{
    ...
    public static class PuzzlePalette
    {
        public sealed class ColorPool
        {
            ...
            public (string id, int cost)[] Rush;
            public string Life;
        }
        ...
        public static readonly Dictionary<string, ColorPool> ByColor = new Dictionary<string, ColorPool>
        {
            ["Red"] = new ColorPool
            {
                ...
                Blockers = new (string, int)[] { ("OP01-019", 2), ("OP02-012", 2), ("OP03-010", 2), ("OP05-013", 2), ("OP08-003", 2) },
            ...
            ["Blue"] = new ColorPool
            {
                ...
                Blockers = new (string, int)[] { ("OP03-050", 2), ("OP05-052", 2), ("OP09-054", 2), ("OP16-043", 2), ("OP16-044", 2) },
