...
namespace OnePieceTcg.Engine.Puzzles
{
    ...
    public static class PuzzleLibrary
    {
        ...
        {
            /* D1 Easy   */ 18, 89, 22, 93, 27, 200, 29, 283, 31, 142, 186, 206, 237, 259, 270, 274, 316, 342, 349, 355, 366, 383, 412, 421, 474,
            /* D2 Medium */ 1, 21, 364, 6, 28, 368, 7, 63, 493, 8, 73, 11, 99, 19, 130, 37, 172, 53, 194, 62, 295, 97, 405, 109, 512,
            /* D3 Hard   */ 12, 39, 115, 192, 43, 80, 132, 398, 67, 123, 229, 129, 152, 310, 187, 165, 365, 201, 183, 380, 203, 228, 475, 214, 252, 520, 227, 254, 533, 235,
            /* D4 Expert */ 2, 32, 91, 4, 49, 108, 26, 83, 135, 30, 102, 141, 81, 103, 176, 159, 171, 218, 277, 189,
        };
