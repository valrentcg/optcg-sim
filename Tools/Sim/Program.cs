...
switch (mode)
{
    ...
    case "retiresweep":
        return OnePieceTcg.Sim.RetireFalsePositiveSweep.Run();
    case "paidfornothing":
        return OnePieceTcg.Sim.PaidForNothingSweep.Run();
    case "optionalfires":
    ...
    case "revealcost":
        return OnePieceTcg.Sim.RevealCostTest.Run();
    case "glowsweep":
    ...
    case "lifefacing":
        return OnePieceTcg.Sim.LifeFacingSweep.Run();
    case "wordingvariant":
    ...
    case "promptzone":
        return OnePieceTcg.Sim.PromptZoneTest.Run();
    case "costlabel":
        return OnePieceTcg.Sim.CostLabelTest.Run();
    case "uptonrider":
    ...
    case "autopick":
        return OnePieceTcg.Sim.AutoPickSweep.Run();
    case "selfdisposal":
        return OnePieceTcg.Sim.SelfDisposalChoiceTest.Run();
    case "opponentpicks":
        return OnePieceTcg.Sim.OpponentPicksTest.Run();
    case "opponentbranch":
        return OnePieceTcg.Sim.OpponentBranchTest.Run();
    case "opponentdecides":
        return OnePieceTcg.Sim.OpponentDecidesTest.Run();
    case "optionalonce":
        return OnePieceTcg.Sim.OptionalOnceSkipTest.Run();
    case "onceperturn":
        return OnePieceTcg.Sim.OncePerTurnTest.Run();
    case "donthreshold":
        return OnePieceTcg.Sim.DonThresholdTest.Run();
    case "realplay":
        return OnePieceTcg.Sim.RealPlayEndToEndTest.Run();
    case "bodyoutcome":
        return OnePieceTcg.Sim.BodyOutcomeTest.Run();
    case "costshapes":
        return OnePieceTcg.Sim.CostShapeGapTest.Run();
    case "lifeshapes":
    ...
    case "countercost":
        return OnePieceTcg.Sim.CounterCostTest.Run();
    case "donrest":
