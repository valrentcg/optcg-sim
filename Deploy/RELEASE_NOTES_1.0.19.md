...
> **Coming from v1.0.17?** This update also bundles everything from **v1.0.18** — the AI overhaul, the
> smooth difficulty curve, more card fixes, and the friends blocked-list. Those are listed at the bottom
> under "Also new since v1.0.17 (from v1.0.18)".
...
# Also new since v1.0.17 (from v1.0.18)

If you're updating from v1.0.17, you also get everything from the v1.0.18 release below.

## 🎚️ A smooth difficulty curve
